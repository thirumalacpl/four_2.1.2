...
var chatr='<br><div class="ui-grid-b"  id="image"><div class="ui-block-a msg_grid_3" style="margin-top: 6%;"> <i class="zmdi zmdi-time zmd-fw" style="    opacity: 0.5; padding-left:7%;"></i><span class="msg_span_3">'+time+'</span><br><span class="msg_span_3">'+date+'</span>  </div><div class="ui-block-b msg_box msg_grid_4 msg_mid_bgg"><p class="msg_grid_p_1 "><a href="#"  class=""><img src="http://fourthforce.in/verifynew/super/'+activity_lok_obj.document+'"  class="imgsize" alt="Wait your <br>image is <br>uploading" onerror="imgError(this);"></a></p></div><div class="ui-block-c msg_grid_5 msg_grid_5_1"><img src="images/primary/chat-icon.png" alt="" class="p_img_grid" style="width:80px;"><br><p class="p_msg_grid">'+username_tvo+'</p></div></div> '
...
$.ajax({
  type: "POST",
url: "http://fourthforce.in/verifynew/slim_four_rips/sdoc.php?verification_user_id="+verification_user_id+"&coordinator_id="+coordinator_id+"&res="+res+"&qualification_id="+qualification_id+"&user_id="+user_id,
...
$.ajax({
  type: "POST",
  url: "http://fourthforce.in/verifynew/slim_four_rips/lifeint.php?verification_user_id="+verification_user_id+"&coordinator_id="+coordinator_id+"&qualification_id="+qualification_id+"&inte="+inte+"&inte_rat="+inte_rat+"&beh="+beh+"&beh_rat="+beh_rat+"&hab="+hab+"&hab_rat="+hab_rat,
...
$.ajax({url: 'http://fourthforce.in/verifynew/slim_four_rips/count.php?region='+region+"&user_id="+user_id+"&state="+state,
