...
// /alert(oneemp);
  $('.sdd').append('<li><a href="http://fourthforce.in/verifynew/uploads/'+oneemp+'"><img src="http://fourthforce.in/verifynew/uploads/'+oneemp+'" style="height: 100%;width:100%" ></a></li>');
...
var oneemp=employimg_obj.document;
//alert(oneemp);
  $('.sddqiveri').append('<li><a href="http://fourthforce.in/verifynew/uploads/'+oneemp+'"><img src="http://fourthforce.in/verifynew/uploads/'+oneemp+'" style="height: 100%;width:100%" ></a></li>');
...
//alert(oneemp);
  $('.sdd').append('<li><a href="http://fourthforce.in/verifynew/documents/addressid/'+oneemp+'"><img src="http://fourthforce.in/verifynew/documents/addressid/'+oneemp+'" style="height: 100%;width:100%" ></a></li>');
